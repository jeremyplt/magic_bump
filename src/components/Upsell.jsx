    ...
    >
      <Layout>
          ...
          <Layout.Section fullWidth>
            ...
            >
              ...
              <div style={{ marginTop: "5px" }}>
                ...
                <p style={{ marginTop: "5px" }}>
                  If you put a <b style={{ color: "#102354" }}>Blue Cap</b> as a
                  global upsell for the whole{" "}
        ...
        <Layout.Section oneHalf>
          <Card title="Product Upsells" actions={[{ content: "Manage all" }]}>
            <Card.Section>
              <TextStyle variation="subdued">6 products with upsells</TextStyle>
            </Card.Section>
          ...
          <Card title="All Products" actions={[{ content: "Add Upsell" }]}>
            <Card.Section>
              <Stack>
                <Stack.Item fill>
                  <p>
                    This upsell will apply on all products. More accurate rules
                    (collections and products) will override this upsell for the
