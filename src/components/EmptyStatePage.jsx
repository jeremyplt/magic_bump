  ...
  return (
    <Page>
      ...
      <Card title="Step 1 of 3: Select products you want to add a bump on">
        <Card.Section>
          <p>
            Bump will be displayed only on the product page you select. You can
            add or remove products later.
          </p>
        </Card.Section>
        <Card.Section>
          <Layout>
      ...
      >
        <p>
          This is the fun part! Design your bump colors, shape, font and more.
        </p>
      </Card>
      <Card
